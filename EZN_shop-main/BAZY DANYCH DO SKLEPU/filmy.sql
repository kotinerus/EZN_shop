...
--
-- Host: 127.0.0.1
-- Czas generowania: 01 Gru 2021, 08:00
...
(1, 'DIUNA', 'Szlachetny ród Atrydów przybywa na Diunę, będącą jedynym źródłem najcenniejszej substancji we wszechświecie.', 10, 30, 3, 'https://fwcdn.pl/fpo/94/76/469476/7972251.6.jpg', 'akcja', 'diuna.php'),
(3, 'CHŁOPI', 'Piękna dziewczyna rozkochuje w sobie bogatego gospodarza i jego syna, wprowadzając niemały zamęt we wsi.', 6, 35, 1, 'https://fwcdn.pl/fpo/60/69/206069/7425790.6.jpg', 'familijny', 'chlopi.php'),
(6, 'PULP FICTION', 'Przemoc i odkupienie w opowieści o dwóch płatnych mordercach pracujących na zlecenie mafii, żonie gangstera, bokserze i parze okradającej ludzi w restauracji.', 9, 42, 2, 'https://fwcdn.pl/fpo/10/39/1039/7710420.6.jpg', 'akcja', 'pulp.php'),
...
(8, 'STAR WARS: NOWA NADZIEJA', 'Złowrogie Imperium zawładnęło galaktyką. Uwięzionej przez Dartha Vadera księżniczce Lei z nieoczekiwaną pomocą przyjdą kosmiczny przemytnik Han Solo i młody Luke Skywalker.', 10, 18, 2, 'https://fwcdn.pl/fpo/07/59/759/7301614.6.jpg', 'akcja', 'starwars.php'),
(9, 'INTERSTELLER', 'Byt ludzkości na Ziemi dobiega końca wskutek zmian klimatycznych. Grupa naukowców odkrywa tunel czasoprzestrzenny, który umożliwia poszukiwanie nowego domu.', 9, 28, 1, 'https://fwcdn.pl/fpo/56/29/375629/7670122.6.jpg', 'akcja', 'intersteller.php'),
