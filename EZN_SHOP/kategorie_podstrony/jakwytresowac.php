    ...
    <div class="main">
        ...
        <?php
             ...
             while ($zf = mysqli_fetch_array($zapfamilijny)) {
                 echo "<section class='sekcje'><img src='" . $zf['obraz'] . "'class='img_sekcja'>" . "<h4>" . $zf['tytul']. "</h4>" . "<br>" . "Cena " . $zf['cena'] . "zł<br>ocena " . $zf['ocena'] . "<br></section><section class='sekcje'>" . $zf['opis']. "<br><br><button>SPRAWDŹ</button></section>";
             }
                 mysqli_close($conn);
        ?>
    </div>
