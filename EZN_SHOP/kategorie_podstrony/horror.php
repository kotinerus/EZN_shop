...
<body>
    ...
    <div class="main">
        ...
        $zaphorror = mysqli_query($conn, "SELECT tytul, cena, ocena, ilosc, obraz, link FROM filmy WHERE kategoria = 'horror'");
        while ($zh = mysqli_fetch_array($zaphorror)) {
            echo "<section class='sekcje'><a href='". $zh['link'] . "'><img src='" . $zh['obraz'] . "'class='img_sekcja'></a>" . "<h4>" . $zh['tytul'] . "</h4>" . "<br>" . "Cena " . $zh['cena'] . "zł<br>". zrobGwiazdki($zh['ocena']) . "<div class='gwiazdki'></div>" . "<br></section>";
        }
