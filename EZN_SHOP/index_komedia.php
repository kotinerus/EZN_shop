...
<head>
    ...
    <title>Space Shop - Komedia</title>
...
<body>
    ...
    <div class="main">
            <?php
                ...
                $zapkomedia = mysqli_query($conn, "SELECT tytul, cena, ocena, ilosc, obraz FROM filmy WHERE kategoria = 'komedia'");
                while($zk = mysqli_fetch_array($zapkomedia)){
                    echo "<section class='sekcje'><img src='".$zk['obraz']."' class='img_sekcja'><h3>" .$zk['tytul'] ."</h3>" . "<br>Cena " . $zk['cena'] . "zł<br>ocena " . $zk['ocena'] . "<br><button>SPRAWDŹ</button></section>";
                }
