...
<body>
    ...
    <div class="main">
        ...
        <?php
             ...
             $zapfamilijny = mysqli_query($conn, "SELECT tytul, cena, ocena, ilosc, obraz, link, opis FROM filmy WHERE tytul = 'CHłOPI'");
             while ($zf = mysqli_fetch_array($zapfamilijny)) { 
                 echo "<section class='sekcje'><img src='" . $zf['obraz'] . "'class='img_sekcja'>" . "<h4>" . $zf['tytul']. "</h4>" . "<br>" . "Cena " . $zf['cena'] . "zł<br>ocena " .  zrobGwiazdki($zf['ocena']) . "<div class='gwiazdki'></div>" . "<br></section><section class='opis'>" . $zf['opis']. "<br><br><button>DODAJ DO KOSZYKA</button></section>";
             }
                 mysqli_close($conn);
        ?>
    </div>
