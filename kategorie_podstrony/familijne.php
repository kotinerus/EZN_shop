...
<body>
    ...
    <div class="main">
        ...
        while ($zf = mysqli_fetch_array($zapfamilijny)) {
            echo "<section class='sekcje'><a href='". $zf['link'] . "'><img src='" . $zf['obraz'] . "'class='img_sekcja'></a>" . "<h4>" . $zf['tytul'] . "</h4>" . "<br>" . "Cena " . $zf['cena'] . "zł<br> " . zrobGwiazdki($zf['ocena']) . "<div class='gwiazdki'></div>". "<br></section>";
        }
